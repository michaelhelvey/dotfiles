...
require('lazy').setup({
  ...
  -- Random dumping ground for all other plugins
  'tpope/vim-fugitive',
  'tpope/vim-rhubarb',
  'tpope/vim-surround',
  'justinmk/vim-sneak',
  ...
  'prisma/vim-prisma',
  {
    'github/copilot.vim',
    config = function()
      -- If we don't do this, it will yell about nvim-cmp having also mapped <Tab>
  ...
  },
  {
    ...
    config = function()
      require('nvim-autopairs').setup({
        -- integrate with nvim-cmp or whatever here if required
      })
    end
  },
